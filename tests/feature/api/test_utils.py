...
def test_get_create_auction_query():
    ...
    data_declared_stock = utils.get_create_auction_query(CreateAuctionMock, type="declaredstock")
...
def test_get_update_auction_query():
    ...
    data_declared_stock = utils.get_update_auction_query(UpdateAuctionMock, type="declaredstock")
    assert "query" in data_declared_stock
